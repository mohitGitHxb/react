  ...
  return (
    <section class="text-white body-font">
      <div class="container px-5 py-20 mx-auto ">
        ...
        <div class="flex flex-wrap -mx-4 -mb-10 justify-center gap-1 sm:gap-4 text-center">
          <div class="sm:w-2/5 mb-10 slide-in-blurred-bottom px-4 glassmorphism-01 py-3">
          ...
          <div class="sm:w-2/5 mb-10 px-4 slide-in-blurred-bottom glassmorphism-01 py-3">
